          ...
          <div className='About_InfoContainer'>
            <div className='About_InfoContentGroup'>
              ...
              <p className='About_InfoDescription'>
                ...
                <br></br> <br></br><br></br>
                I'm Mike Hovedskov, a passionate web application designer and developer with a focus on UI/UX Design. I specialize in creating visually stunning front-end web applications, all with my unique perspective on UI/UX Design. I have expertise in mock-ups, photo editing, image cropping, photo manipulation, and other graphic design services. I have an AP Degree in Computer Science with a top grade and I am currently in the process of getting my bachelor's degree in web design, which I hope will conclude in January 2025. I have been around computers my whole life and always had a curiosity for technical work. My love for programming and clean, elegant design has helped me become a professional and interactive website developer. I'm always looking to further my knowledge and utilize the latest and greatest tools available.
              </p>
            </div>
            <div className='About_InfoContentGroup'>
